# 윈도어맨. [스마트 창문 자동화를 통해 실내 및 실외의 쾌적한 환경을 유지하는 솔루션]
...
- **사용자 맞춤 스케줄링 서비스**  
  <div style="display: flex;"> <div style="margin-right: 10px;"> <img src="docs_assets/setting.gif" alt="예약 설정" style="max-width: 100%;"> </div> <div> <img src="docs_assets/open.gif" alt="실제 동작" style="max-width: 100%;"> </div> </div>
...
| Backend | 사용자 인증 및 JWT 기반 로그인 기능 | 김민경 (팀장) | 프로젝트 리더, 백엔드 설계 및 개발 주도, 인증 시스템 구축 |
|  | 스케줄 관리 기능 개발 (Quartz 스케줄러 이용) | 김민경 (팀장) | 스케줄링 기능 설계 및 구현, 사용자 맞춤 알람 기능 도입 |
|  | 실시간 센서 데이터 수집 및 처리 API 개발 | 김민경 (팀장) | 실시간 데이터 처리 로직 설계 및 API 구축 |
|  | Elasticsearch 연동 및 로그 데이터 저장 기능 | 이재민 | 데이터 연동 설계 및 로그 저장, 효율적인 데이터 인덱싱 구현 |
|  | Spring Batch를 이용한 주기적인 데이터 수집 및 처리 | 이재민 | 데이터 배치 처리 설계 및 개발, 주기적 데이터 수집 자동화 |
|  | 알람 스케줄링 및 메시지 큐(RabbitMQ) 기반 알람 전달 기능 | 이재민 | 메시지 큐 사용한 알람 시스템 구축, 사용자 알람 전달 최적화 |
|  | REST API 개발 및 데이터 CRUD 기능 구현 | 홍경현 | RESTful API 설계, 데이터 관리 및 CRUD 구현 |
|  | Redis를 활용한 최신 센서 데이터 캐싱 기능 | 홍경현 | 캐싱 전략 설계, 실시간 데이터 접근성 개선 |
