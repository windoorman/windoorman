        ...
        try:
            ...
            indoor_response = self.es.search(
                ...
                body={
                    ...
                    "_source": ["temp", "humid", "pm10", "pm25", "tvoc", "co2"]
                }
            )
            # 최신 실외 데이터 조회
            ...
            # 실내 데이터
            indoor_data = format_data(indoor_response["hits"]["hits"][0]["_source"]) if indoor_response["hits"]["hits"] else None
            # 실외 데이터
            outdoor_data = format_data(outdoor_response["hits"]["hits"][0]["_source"]) if outdoor_response["hits"]["hits"] else None
